...
\input{2-background}                    % background and framework for POCL planning and ILPs
\input{3-relatedWork}                   % related work
\input{4-heuristic}                     % The ILP-based delete relaxation heuristic
\input{5-efficiencyImprovements}        % efficiency improvements to the heuristic
\input{6-evaluation}                    % evaluation
\input{7-discussion}                    % discussion
\input{8-conclusion}                    % conclusion
\input{9-futureWork}                    % pootential future improvements and extensions of this work
