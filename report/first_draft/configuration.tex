...
\newcommand{\ProjectTitle} {ILP-based delete relaxation heuristics for Partial Order Causal Link (POCL) Planning}
...
\newcommand{\CourseCode} {COMP3770}
\newcommand{\CourseName} {Computing Research Project (R\&D)}
