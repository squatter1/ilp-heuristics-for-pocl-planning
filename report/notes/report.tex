...
\section{Because Pascal is lazy: Other citations}

\begin{itemize}
  \item Check out other important works using POCL planning. E.g., Christian Muise as several works (cited in my POCL papers) that could be cited as important works that exploit the POCL data structure. Some others might exist as well (again: check my POCL papers)
\end{itemize}
